...
exports.auth = (req, res, next) => {
    try {
        ...
        console.error('Error while token validating');
        console.error(error);
...
exports.isStudent = (req, res, next) => {
    try {
        ...
        console.error('Error while cheching user validity with student accountType');
        console.error(error);
        return res.status(500).json({
            success: false,
            error: error.message,
...
exports.isInstructor = (req, res, next) => {
    try {
        ...
        console.error('Error while cheching user validity with Instructor accountType');
        console.error(error);
        return res.status(500).json({
            success: false,
            error: error.message,
...
exports.isAdmin = (req, res, next) => {
    try {
        ...
        console.error('Error while cheching user validity with Admin accountType');
        console.error(error);
        return res.status(500).json({
            success: false,
            error: error.message,
