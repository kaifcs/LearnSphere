  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        courses.length > 0 ? (
          <div>
            <div className="my-4 flex min-h-[350px] gap-4">
              {/* Render chart / graph */}
              {totalAmount > 0 || totalStudents > 0 ? (
                <div className="flex-1 overflow-hidden rounded-md bg-richblack-800 p-4">
              ...
              {/* left column */}
              {/* Total Statistics */}
              <div className="w-full lg:w-[250px] flex flex-col rounded-md bg-richblack-800 p-6">
