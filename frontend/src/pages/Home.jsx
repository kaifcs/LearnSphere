...
const Home = () => {
    ...
    const [backgroundImg] = useState(() => images[Math.floor(Math.random() * images.length)]);
                        ...
                        <div className='flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]'>
                            ...
                            <div className='flex flex-col gap-10 w-full lg:w-[40%] items-start'>
                                <div className='text-[16px]'>
                                    To stay ahead in today's rapidly evolving tech landscape, you need more than just foundational knowledge. LearnSphere equips you with the modern tools, real-world projects, and industry insights required to build a lasting career.
                                </div>
                                <CTAButton active={true} linkto={"/signup"}>
                                    <div>
                                        Learn more
